            ...
            <div class="row no-wrap q-pa-lg">
              <div class="column">
                ...
                <div class="items-center">
                  <div class="text-bold items-center">18415025</div>
                  <div>Sandi Irawan</div>
                </div>
              </div>
      ...
      <q-scroll-area class="fit">
        <q-list>
          <q-item style="height: 50px;" class="bg-white text-bold text-center">
            <q-item-section>
              Aplikasi Penjualan Tas
            </q-item-section>
          </q-item>
          <q-item class="justify-center text-center q-mb-md q-pt-md">
            <div>
              <q-avatar size="200px" class="q-mb-md">
                <img src="/statics/admin.png" alt="gambar">
              </q-avatar>
              <div class="text-weight-bold">18415025</div>
              <div>Sandi Irawan</div>
              <div>ADMIN</div>
            </div>
          </q-item>
          ...
          <q-item clickable active-class="active" exact v-ripple to="/admin/">
            ...
            <q-item clickable active-class="active" exact v-ripple to="/admin/inputdatatas">
            <q-item-section avatar>
              <q-icon name="input" />
            </q-item-section>
            <q-item-section>
